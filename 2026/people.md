...
<img width='200' height='200' src="{{ site.baseurl }}/2026/assets/images/people/{{ author.image }}"><br/>
<figcaption>
{{ author.major }}<br/>
({{ author.pronouns }})<br/>
...
<figure>
<b> {{ author.name }} </b><br/>
<img src="{{ site.baseurl }}/2026/assets/images/people/{{ author.image }}" width="200" height="200"><br/>
<figcaption>
