...
| 2 | Order of magnitude estimates of the central dogma and trophic cascades |
| 3 | Probing deep time using radiometric dating and order-of-magnitude estimates about mutations over time. |
| 4 | Writing stochastic simulations in Python and influence of genetic drift.|
| 5 | Principles and mechanism of photosynthesis |
| 6 | Introduction to quantitative image processing using Python. |
| 7 | Performing non-linear regression. |
| 8 | To be determined. |
| 9 | To be determined. |
