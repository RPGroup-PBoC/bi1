...
Lecture occurs twice a week (Tuesdays and Thursdays) from 1:00 - 2:25 pm in 119
Kerckhoff. These sessions will involve lecture and in-class participation
...
will take during normal recitation times and locations. While many programming
...
**`McClintock_Barbara_hw1_prob3.ipynb`**.
...
will not be accepted without penalty**. For each day a homework assignment is
late, a 10% deduction will be made from the maximum possible score. For
example, a homework received five days late will maximally earn 50%. Attendance
is expected of all students in the class. As a general rule "on time" means
that you are sitting in the class room five minutes early.
