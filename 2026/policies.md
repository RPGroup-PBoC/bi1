...
There will be no exams, quizzes, reports, or research proposals; your final grade is based entirely on [homework]({{ site.baseurl }}/2026/homework).
...
Details on how to work with Colab (including guidelines for code submissions) can be found on the [homework page]({{ site.baseurl }}/2026/homework).
