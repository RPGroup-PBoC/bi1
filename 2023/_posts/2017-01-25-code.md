...
If you already feel prepared to tackle the programming questions, feel free to only attend the tutorials you want/need. Remember that some of your classmates will never have written a single line of code before this class! We encourage you to help each other learn.
...
| Date | Topic | Links |
| :--: | -- | -- |
| Tuesday, April 11 | Intro to Python for image segmentation. | |
| Tuesday, April 18 | Computational sequence analysis. | |
| Tuesday, April 25 | Dating fossils using radioactive decay. | |
| Tuesday, May 2 | Exploring evolution with stochastic simulations. | |
| Tuesday, May 9 | tbd | |
| Tuesday, May 16 | tbd | |
| Tuesday, May 23 | Making microscopy quantitative. | |
| Tuesday, May 30 | tbd | |
| Tuesday, June 6 | tbd | |
